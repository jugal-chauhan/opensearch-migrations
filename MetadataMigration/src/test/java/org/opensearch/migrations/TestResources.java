...
public class TestResources {
    ...
    public static final Snapshot SNAPSHOT_ES_5_6_KIBANA;
    ...
    static {
        ...
        SNAPSHOT_ES_5_6_KIBANA = new Snapshot(
                rfsBaseDir.resolve(Paths.get("test-resources", "snapshots", "ES_5_6_Kibana_Dashboards")),
                "snapshot_1"
        );
